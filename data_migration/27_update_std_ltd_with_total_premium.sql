...
SET total_premium_per_month = LEAST(cltd.max_benefit_monthly * 12, cltd.percentage_of_salary * ep.annual_base_salary / 100) / 12 * cltd.rate / 10
...
SET total_premium_per_month = LEAST(cstd.max_benefit_weekly * 52, cstd.percentage_of_salary * ep.annual_base_salary / 100) / 12 * cstd.rate / 10
