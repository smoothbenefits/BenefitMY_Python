...
-- Find all company supplemental life plans that currently are 
...
FROM app_compsuppllifeinsuranceplan clip
LEFT OUTER JOIN app_companygroupsuppllifeinsuranceplan cgblip
ON clip.id = cgblip.company_suppl_life_insurance_plan_id
WHERE cgblip.company_suppl_life_insurance_plan_id IS NULL;
...
INSERT INTO app_companygroupsuppllifeinsuranceplan(company_suppl_life_insurance_plan_id, company_group_id, created_at, updated_at)
