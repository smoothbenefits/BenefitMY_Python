...
LEFT OUTER JOIN app_fsaplan p
ON p.id = cp.fsa_plan_id
WHERE cgp.company_fsa_plan_id IS NULL;
...
INSERT INTO app_companygroupfsaplan(company_fsa_plan_id, company_group_id, created_at, updated_at)
