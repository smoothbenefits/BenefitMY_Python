...
Whenever possible, the company makes reasonable accommodations for qualified individuals with disabilities to the extent required by law. Employees who would like to request a reasonable accommodation should contact {{COMPANYHRMANAGERNAME}}.
...
3.3 Payday
Paychecks are distributed every month. If the pay date lands on a holiday, paychecks will be distributed on the closest business day before the holiday.
Paychecks include salary or wages earned less any mandatory or elected deductions. Mandatory deductions include federal or state withholding tax, and other withholdings. Elected deductions are deductions authorized by the employee, and may include, for example, contributions to benefit plans. Employees may contact [enter authorized person’s name] to obtain the necessary authorization forms for requesting additional deductions from their paychecks.
...
Any change in name, address, telephone number, marital status or number of exemptions claimed by an employee must be reported to {{COMPANYHRMANAGERNAME}}  immediately.
...
Phones are provided for business use. The company requests that employees not receive personal calls while on duty. If urgent, please keep personal calls to a minimum and conversations brief. Personal long distance calls are not permitted.
...
4.3 Part Time, Full Time or Temporary Status
Part-time or full-time status depends on the number of hours per week an employee works. Regular employees who work fewer than 40 hours receive part-time classification. Part-time employees are not eligible for employee benefits as described in this handbook. Regular employees who work at least 40 hours receive full-time classification.
From time to time the company may hire employees for specific projects or periods of time. Temporary employees may work either part-time or full-time, but generally are scheduled to terminate by a certain date. Temporary employees who remain on duty past the scheduled termination remain classified as temporary. Only {{COMPANYHRMANAGERNAME}} may change an employee’s temporary status. Temporary employees are not eligible for employment benefits.

Section 5 – Attendance Policies
5.1 GeneralAttendance
The company maintains normal working hours of 8-5. Hours may vary depending on work location and job responsibilities. Supervisors will provide employees with their work schedule. Should an employee have any questions regarding his/her work schedule, the employee should contact the supervisor.
The company does not tolerate absenteeism without excuse. Employees who will be late to or absent from work should notify a supervisor in advance, or as soon as practicable in the event of an emergency. Chronic absenteeism may result in disciplinary action.
...
5.2 Tardiness
Employees are expected to arrive on time and ready for work. An employee who arrives 60 minutes after their scheduled arrival time is considered tardy. The company recognizes that situations arise which hinder punctuality; regardless, excessive tardiness is prohibited, and may be subject to disciplinary action.
5.3 Breaks
When working conditions permit, and pending a supervisor’s approval, employees are entitled to 15 minute breaks for every two hours worked.
Meal periods are for 60 minutes, and must be approved by a supervisor.
...
A regular employee is eligible to receive paid time off after [enter number] months of full-time service. Accrued time off may be taken after [enter eligibility dates]. Employees must earn and accrue vacation benefits before they may be used. Employees should consult {{COMPANYHRMANAGERNAME}} regarding the amount of vacation leave they accrue each pay period.
...
6.2 Sick Leave
Situations may arise where an employee needs to take time off to address medical or other health concerns. The company requests that employees provide notification to their supervisor as soon as practicable when taking time off. Sick days are granted on an unpaid basis to regular employees. Employees may consult {{COMPANYHRMANAGERNAME}} regarding the amount of (paid) sick leave provided each year. Sick days may not be carried over into the next year. Abuse of this policy may result in disciplinary action.
6.3 Family and Medical Leave Act Leave
The company offers leave consistent with the requirements of the federal Family and Medical Leave Act (FMLA). Under the FMLA, an employee may be eligible for an
...
-  Thanksgiving
-  Christmas Day
and other holidays that are mandated holidays by the state.
Holidays are observed on a [paid/unpaid] basis for all eligible employees. [Full time employees are eligible for paid holiday benefits.]
...
This handbook contains descriptions of some of our current employee benefits. Many of the company’s benefit plans are described in more formal plan documents available from {{COMPANYHRMANAGERNAME}}. In the event of any inconsistencies between this handbook or any other oral or written description of benefits and a formal plan document, the formal plan document will govern.
10.1 Health Insurance
The company makes group health benefits available to eligible employees and their family members. Eligible employees are full time employees who have worked for 12 months. Part time employees are eligible if they work at least 30 hours per week and have been employed for 12 months.
Health benefits are paid in part by the company. The remainder of the costs is the employee’s responsibility. Employees can receive details about benefits provided, contribution rates and eligibility from {{COMPANYHRMANAGERNAME}}.
10.2 RetirementPlan
The company participates in a 401(k) plan so that employees may save a portion of their earnings for retirement. Regular employees who have worked at least 40 hours/week for 12 months are eligible to participate. Employees may elect to make regular contributions to the 401(k) plan up to the maximum amount allowed by federal law.
Contact {{COMPANYHRMANAGERNAME}} for detailed information regarding eligibility, employee contributions, vesting period or employer contributions. More information can also be found in the plan summary description, which is available from {{COMPANYHRMANAGERNAME}}. If there are any inconsistencies between this handbook and any of the Summary Plan Descriptions, the Summary Plan Descriptions shall govern. The company reserves the right to modify or terminate any or all of its retirement benefits or to change benefit providers at any time with or without notice.
...
A separate insurance company administers the worker’s compensation insurance. Representatives of this company may contact injured employees regarding their benefits under the plan. Additional information regarding workers’ compensation is available from {{COMPANYHRMANAGERNAME}}.
10.4 Disability Coverage
Disability insurance provides partial paycheck reimbursement for times of serious illness or injury which leads to total disability. Total disability is defined as the inability to perform any job function as a result of the injury or illness. Employees who have worked for 12 months are eligible for disability insurance coverage. To qualify for benefits, the period of total disability must exceed 30 days.

Coverage extends for 30 days of disability. Employees must exhaust any sick leave benefits before being eligible for disability leave coverage.
Disability benefits are calculated as a percentage of an employees base salary as defined by the state law. Any payments received from worker’s compensation or state disability will result in an equal decrease in disability benefits. Disability benefits are subject to employment withholding provisions.
The employee is responsible for notifying a supervisor of their disability, expected date of return, and the name of their attending physician. The company may request that an independent medical provider perform an examination. In addition, the company may require a medical release form prior to returning to work. For more information regarding disability benefits, contact [enter authorized person’s name]. If there are any inconsistencies between this handbook and any of the Summary Plan Descriptions, the Summary Plan Descriptions shall govern. The company reserves the right to modify or terminate any or all of the benefits or to change benefit providers at any time with or without notice.
...
Acknowledgement of Receipt for Employee Handbook (Employee Copy – Keep with handbook)
...
IF NOT EXISTS (select 1 from app_documenttype where name = 'Employee Handbook') THEN
    insert into app_documenttype(id, name, default_content) values(5, 'Employee Handbook', content);
ELSE
