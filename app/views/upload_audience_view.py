...
class UploadAudienceView(APIView):
    ...
    def _get_uploads_for_all_company(self, company_id):
    ...
    def _get_uploads_for_request(self, request, comp_id):
        ...
        if user_id:
            ...
            upload_audience = self._get_uploads_for_all_company(comp_id)
        return upload_audience

    # PK is always the company_id
    def get(self, request, pk, format=None):
        upload_audience = self._get_uploads_for_request(request, pk)
