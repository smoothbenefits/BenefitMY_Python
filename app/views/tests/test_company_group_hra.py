...
class CompanyGroupHraTestCase(TestCase, ViewTestBase):
    ...
    def test_get_company_group_hra_plan_by_company_group_empty(self):
        response = self.client.get(reverse('company_group_hra_plan_api',
    ...
    def test_get_company_group_hra_plan_by_company_group_non_exist(self):
        response = self.client.get(reverse('company_group_hra_plan_api',
    ...
    def test_get_company_group_hra_plan_by_company_plan_success(self):
        response = self.client.get(reverse('company_group_hra_plan_by_company_plan_api',
    ...
    def test_get_company_group_hra_plan_by_company_plan_non_exist(self):
        response = self.client.get(reverse('company_group_hra_plan_by_company_plan_api',
                                           kwargs={'pk':self.normalize_key(9999)}))
        self.assertIsNotNone(response)
        self.assertEqual(response.status_code, 404)

    def test_put_company_group_hra_plan_by_company_plan_success(self):
        company_group_data = [
                                {'company_group': self.normalize_key(3),
                                 'company_hra_plan': self.normalize_key(1)
                                },
                                {'company_group': self.normalize_key(2),
                                 'company_hra_plan': self.normalize_key(1)
                                }
                             ]
        response = self.client.put(reverse('company_group_hra_plan_by_company_plan_api',
                                           kwargs={'pk':self.normalize_key(1)}),
    ...
    def test_put_company_group_hra_plan_by_company_plan_non_exist(self):
        company_group_data = [
                                {'company_group': self.normalize_key(3),
                                 'company_hra_plan': self.normalize_key(1)
                                },
    ...
    def test_post_company_group_hra_plan_by_company_plan_success(self):
        company_group_data = [
                                {'company_group': self.normalize_key(3),
                                 'company_hra_plan': self.normalize_key(2)
                                },
        ...
        response = self.client.post(reverse('company_group_hra_plan_by_company_plan_api',
    ...
    def test_post_company_group_hra_plan_by_company_plan_non_exist(self):
        company_group_data = [
                                {'company_group': self.normalize_key(3),
                                 'company_hra_plan': self.normalize_key(1)
                                }
    ...
    def test_delete_company_group_hra_plan_by_company_plan_success(self):
        response = self.client.delete(reverse('company_group_hra_plan_by_company_plan_api',
                                            kwargs={'pk':self.normalize_key(1)}))
        self.assertIsNotNone(response)
    ...
    def test_delete_company_group_hra_plan_by_company_plan_non_exist(self):
        response = self.client.delete(reverse('company_group_hra_plan_by_company_plan_api',
                                            kwargs={'pk':self.normalize_key(9999)}))
        self.assertIsNotNone(response)
        self.assertEqual(response.status_code, 204)
