...
class EmployeeProfileTestCase(TestCase, ViewTestBase):
    ...
    def test_get_employee_profile_by_person_success(self):
        response = self.client.get(reverse('employee_profile_by_person_api',
    ...
    def test_get_employee_profile_exist_person_non_exist_profile(self):
        response = self.client.get(reverse('employee_profile_by_person_api',
