...
class CompanyUsersLifeInsuranceBeneficiaryExcelTestCase(TestCase, ViewTestBase):
    ...
    def test_get_life_insurance_beneficiary_excel_success(self):
        if self.client.login(username='user2@benefitmy.com', password='foobar'):
            response = self.client.get(reverse('company_life_insurance_beneficiary_excel_api',
    ...
    def test_get_life_insurance_beneficiary_excel_non_exist(self):
        if self.client.login(username='user2@benefitmy.com', password='foobar'):
            response = self.client.get(reverse('company_life_insurance_beneficiary_excel_api',
