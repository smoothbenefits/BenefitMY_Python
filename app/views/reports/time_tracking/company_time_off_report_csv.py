...
from app.service.Report.time_tracking.company_time_off_report_service import CompanyTimeOffReportService
from app.service.date_time_service import DateTimeService


class CompanyTimeOffReportCsvView(ReportExportViewBase):
    ...
    def get(self, request, company_id,
        ...
        csv_service = CompanyTimeOffReportService()

        response = HttpResponse(content_type='text/csv')
        response['Content-Disposition'] = 'attachment; filename=time_off_report.csv'
