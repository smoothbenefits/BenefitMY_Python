...
class CompanyPhraseologyViewTestCase(TestCase, ViewTestBase):
    # your fixture files here
    fixtures = ['74_phraseology', '75_company_phraseology', 
                '49_period_definition', '10_company',
                '24_person', '23_auth_user']

    def test_get_company_phraseology(self):
        response = self.client.get(reverse('company_phraseology_api',
    ...
    def test_get_company_phraseology_by_company(self):
        response = self.client.get(reverse('company_phraseology_by_company_api',
    ...
    def test_delete_company_phraseology(self):
        response = self.client.get(reverse('company_phraseology_api',
                                           kwargs={'pk': self.normalize_key(1)}))
        self.assertIsNotNone(response)
        self.assertEqual(response.status_code, 200)

        response = self.client.delete(reverse('company_phraseology_api',
                                              kwargs={'pk': self.normalize_key(1)}))
    ...
    def test_post_company_phraseology(self):
        post_data = {
            "company": 2,
            "phraseology": 6,
        ...
        response = self.client.post(reverse('company_phraseology_post_api'), post_data)
    ...
    def test_put_company_phraseology(self):
        put_data = {
            "id": 2,
            "company": 1,
            "phraseology": 6,
        ...
        response = self.client.put(reverse('company_phraseology_api',
