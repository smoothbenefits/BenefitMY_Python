...
urlpatterns = patterns('app.views',
    ...
    # # Connect Payroll
    url(r'^%s/companies/(?P<company_id>\w+)/connect_payroll/period_export_csv/from/(?P<from_year>\d+)/(?P<from_month>\d+)/(?P<from_day>\d+)/to/(?P<to_year>\d+)/(?P<to_month>\d+)/(?P<to_day>\d+)/?$' % PREFIX, ConnectPayrollPeriodExportCsvView.as_view(), name='company_advantage_payroll_period_export_csv_api'),
