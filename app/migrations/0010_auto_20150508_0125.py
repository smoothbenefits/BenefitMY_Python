    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('self_premium_per_month', models.DecimalField(verbose_name=b'calculated premium for self', max_digits=10, decimal_places=2)),
                ('spouse_premium_per_month', models.DecimalField(verbose_name=b'calculated premium for spouse', max_digits=10, decimal_places=2)),
                ('child_premium_per_month', models.DecimalField(verbose_name=b'calculated premium for child', max_digits=10, decimal_places=2)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
