    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_group', models.ForeignKey(related_name='company_hsa_plan_group', to='app.CompanyGroup')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('company', models.ForeignKey(related_name='company_hsa_plan_company', to='app.Company')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('company_group_hsa_plan', models.ForeignKey(related_name='company_group_hsa_plan', blank=True, to='app.CompanyGroupHsaPlan', null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='company_hsa_plan_company_plan', to='app.CompanyHsaPlan'),
