    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projected_hour', models.DecimalField(null=True, max_digits=12, decimal_places=4, blank=True)),
                ('actual_hour', models.DecimalField(null=True, max_digits=12, decimal_places=4, blank=True)),
