...
class ActionNotifyCompanyNotCompleteOnboarding(ActionNotifyCompanyBase):
    
    def __init__(self):
        super(ActionNotifyCompanyNotCompleteOnboarding, self).__init__()

    def _get_email_data(self, company_id, user_id_list):
        subject = '[Action Required] Employee Onboarding not Completed'
        html_template_path = 'email/system_notifications/company_not_complete_onboarding.html'
        txt_template_path = 'email/system_notifications/company_not_complete_onboarding.txt'
